...
class RevenueSplitViewSet(CustomModelViewSet):
    ...
    def get_queryset(self):
        ...
        game_release_date_after = self.request.query_params.get('game_release_date_after', None)
        game_release_date_before = self.request.query_params.get('game_release_date_before', None)
        ...
        if getattr(self, 'values_queryset', None):
            ...
            self.queryset = queryset.select_related(*self.export_foreignKey__value_column)
        return queryset
