...
# ================================================= #
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=30),  # 缩短访问 Token 时间以提高安全性
    "REFRESH_TOKEN_LIFETIME": timedelta(days=30),  # 保持 Refresh Token 为 30 天
    "AUTH_HEADER_TYPES": ("CUCKOO",),
    "ROTATE_REFRESH_TOKENS": True,  # 刷新时旋转 Refresh Token
    "BLACKLIST_AFTER_ROTATION": True,  # 使旧的 Refresh Token 失效
    "UPDATE_LAST_LOGIN": True,  # 更新用户最后登录时间（可选，增强安全性）
}
