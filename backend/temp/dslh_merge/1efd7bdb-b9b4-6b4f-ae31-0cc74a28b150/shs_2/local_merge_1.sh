#!/bin/bash
SOCDATABASE=ycnrg05xybytest21
DESTDATABASE=ycnrg05xybytest19
DESTSERVERID=101
DB_USER=root
DB_IP=127.0.0.1
DB_PASS="JnC25k4JApFcRyBN"
DB_PORT=33008
BACKUP=/home/merge/merge1
mkdir -p "/home/merge/merge2"
MERGE=/home/merge/merge2
...
delete_mails="DELETE FROM mails WHERE readstatus=1";
...
mysql -u$DB_USER -h $DB_IP -P$DB_PORT ${DESTTEMPDATABASE} -e "${delete_mails}"
echo "数据表清理完成"
