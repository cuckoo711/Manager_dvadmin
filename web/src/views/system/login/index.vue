<template>
      ...
      <div class="login-right-warp flex-margin">
        ...
        <div class="login-right-warp-mian">
          <div class="login-right-warp-main-title">
            {{
              userInfos.pwd_change_count === 0 ? '初次登录修改密码' : getSystemConfig['login.site_title'] ||
                  getThemeConfig.globalTitle
            }}
            {{ userInfos.pwd_change_count === 0 ? '' : '欢迎您！'}}
          </div>
  ...
  <div v-if="siteBg">
    <img :src="siteBg" class="loginBg fixed inset-0 z-1 w-full h-full" alt="loginBg"/>
  </div>
</template>
...
.login-container {
  ...
  .login-left {
    flex: 1;
    position: relative;
    background-color: rgba(211, 239, 255, 0.6);
    margin-right: 100px;
