...
import { SearchUserInfo, DeleteMails, GetServers } from './api';
...
const onSearchUser = async () => {
  ...
  loading.value = true;
  try {
    const res = await SearchUserInfo(serverId.value, uid.value);
...
const onDeleteMails = async () => {
  ...
  loading.value = true;
  try {
    const res = await DeleteMails(serverId.value, uid.value, finalIds);
