...
interface ExtendedCreateCrudOptionsProps extends CreateCrudOptionsProps {
	onhanleModify: (row: any) => void;
}

// 注意：以下FastCrud配置应替换为实际的JavaScript/TypeScript代码片段
export const createCrudOptions = function ({ crudExpose, onhanleModify }: ExtendedCreateCrudOptionsProps): CreateCrudOptionsRet {
			...
			actionbar: {
				buttons: {
					...
					refresh: {
						...
						click: async () => {
							// 弹出确认框
							ElMessageBox.confirm('是否确认手动刷新？', '确认手动刷新', {
			...
			rowHandle: {
				...
				buttons: {
					...
					renew: {
						...
						click: async (obj: any) => {
							// 弹出确认框
							ElMessageBox.confirm('是否确认续费？', '确认续费', {
								confirmButtonText: '确认',
								cancelButtonText: '取消',
								type: 'warning',
							})
					...
					modify: {
						...
						iconRight: '',
						type: 'text',
						show: auth('consoles:Modify'),
						click: async (obj: any) => {
							onhanleModify(obj.row);
						},
					},
				},
			},
