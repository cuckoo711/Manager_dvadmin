<template>
  <el-main class="bg-gray-100">
    <el-row :gutter="15">
      <el-col :xl="4" :lg="6" :md="8" :sm="12" :xs="24" v-for="item in taskList" :key="item.id" class="task-item-col">
            ...
            <div class="state flex flex-wrap items-center">
              ...
              <div class="ml-2">
                <el-popconfirm width="180" confirm-button-text="确定" @confirm="runTask(item)"
                  ...
                  <template #reference>
                    <el-button size="small" circle plain type="success">
                      <el-icon>
                        <Promotion/>
                      </el-icon>
                    </el-button>
      ...
      <el-col :xl="4" :lg="6" :md="8" :sm="12" :xs="24">
        <el-card class="task task-add" shadow="hover" @click="addTaskShow">
          <el-icon>
            <Plus/>
          </el-icon>
          <p>添加计划任务</p>
        ...
        <el-dialog v-model="addTaskDialogVisible" title="添加任务" width="24%" class="el-dialog">
            ...
            <el-row>
              ...
              <el-col>
                <el-form-item label="使用调度模型" required prop="schedule">
                  <el-switch active-text="定时任务" inactive-text="间隔任务"
                             :active-value="1"
                             :inactive-value="0"
          ...
          <template #footer>
            <span class="dialog-footer">
              ...
              <el-button type="primary" @click="addTask(addTaskFormRef)">确定</el-button>
            </span>
          </template>
        ...
        <el-dialog v-model="editTaskDialogVisible" title="编辑任务" width="24%" class="el-dialog">
          ...
          <template #footer>
            <span class="dialog-footer">
              ...
              <el-button type="primary" @click="submitEditTask(editTaskFormRef)">确定</el-button>
            </span>
          </template>
...
import {Delete, Edit, Monitor, Plus, Promotion} from '@element-plus/icons-vue';
import * as api from './api'
import {defineAsyncComponent, onMounted, reactive, ref, toRaw, watch} from 'vue';
...
.task-item-col {
  margin-bottom: 20px; /* 设置每行卡片之间的垂直间距 */
}
