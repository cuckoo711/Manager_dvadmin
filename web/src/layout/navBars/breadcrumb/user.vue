  ...
  <div class="layout-navbars-breadcrumb-user pr15" :style="{ flex: layoutUserFlexNum }">
        ...
        >
          <template #reference>
            <el-badge is-dot class="item" :class="{'online-status': isSocketOpen,'online-down':!isSocketOpen}">
              <img :src="getBaseURL(userInfos.avatar) || headerImage"
                   class="layout-navbars-breadcrumb-user-link-photo mr5" alt=""/>
            </el-badge>
          </template>
        </el-popconfirm>
      </span>
    ...
    <el-dropdown :show-timeout="70" :hide-timeout="50" @command="onHandleCommandClick">
        ...
        <span v-if="isSocketOpen">
          <el-badge is-dot class="item" :class="{'online-status': isSocketOpen,'online-down':!isSocketOpen}">
            <img :src="userInfos.avatar || headerImage" class="layout-navbars-breadcrumb-user-link-photo mr5" alt=""/>
          </el-badge>
        </span>
